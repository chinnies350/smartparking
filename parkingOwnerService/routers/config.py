...
async def get_cursor() -> Cursor:
    dsn = r'Driver={ODBC Driver 17 for SQL Server};Server={192.168.1.221};Database={parking_owner_service};UID={sqldeveloper};PWD={SqlDeveloper$};MARS_Connection=yes;APP=yourapp'
    try:
...
# async def main():
#     async for cur in get_cursor():
#         await cur.execute("SELECT * FROM userMaster")
#         print(cur.fetchall())
#         break
